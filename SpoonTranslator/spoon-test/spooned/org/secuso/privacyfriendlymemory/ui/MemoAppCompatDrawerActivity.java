...
public abstract class MemoAppCompatDrawerActivity extends android.support.v7.app.AppCompatActivity implements android.support.design.widget.NavigationView.OnNavigationItemSelectedListener {
    @java.lang.Override
    ...
    protected void setupNavigationView() {
        ...
        toggle.syncState();
        android.support.design.widget.NavigationView navigationView = ((android.support.design.widget.NavigationView) (findViewById(R.id.nav_view_main)));
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            builder.setNegativeButton(getResources().getString(R.string.quit_no), new android.content.DialogInterface.OnClickListener() {
                public void onClick(android.content.DialogInterface dialog, int id) {
                }
            });
            builder.setPositiveButton(getResources().getString(R.string.quit_yes), new android.content.DialogInterface.OnClickListener() {
                public void onClick(android.content.DialogInterface dialog, int id) {
                    cancelMemory();
                }
            });
