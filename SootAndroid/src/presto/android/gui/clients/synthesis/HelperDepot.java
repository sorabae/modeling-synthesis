...
public class HelperDepot {
  ...
  public final static String template = "/*\n"
      ...
      + "#set( $index = $helper_object.indexOf(\'_\') )"
      + "#if( ${index} < 0 )"
      + "#set( $helper_type = ${helper_object} )"
      + "#else"
      + "#set( $helper_type = $helper_object.substring(0, ${index}) )"
      + "#end"
      + "  public static final ${helper_type} w_${helper_object} = new ${helper_type}();\n"
      + "#end"
      + "  }\n"
  ...
  public static void addBarcodeSupport(RoboSynthesizer.TestCase testCase) {
    testCase.addHelper(f_scanBarcode);
  }

  public static RoboSynthesizer.TestCase afterwards(WTGNode tgt, RoboSynthesizer.TestCase testCase) {
...
//          "assertTrue(\"Menu not open.\", solo.waitForView(" + clsName + "));\n";
  ...
  public static void addAllHelpersToCase(RoboSynthesizer.TestCase tc) {
