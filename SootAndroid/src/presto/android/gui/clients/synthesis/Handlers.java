...
public class Handlers {
  ...
  public static void handlePrestoFakeLauncherNodeClass(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
  ...
  public static void handleObject(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
  ...
  public static void handleActivity(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
  ...
  public static void handleView(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    assert e.getGUIWidget() instanceof NViewAllocNode;
    EventType type = e.getEventType();
  ...
  public static void handleListView(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
...
//            testCase.append("solo.clickInList(DJVU_IDX, 0); // click on a DJVU file");
  ...
  public static void handleRadioGroup(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
  ...
  public static void handleButton(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    assert e.getGUIWidget() instanceof NViewAllocNode
  ...
  public static void handleToggleButton(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
    int resId = HelperDepot.getResId(e.getGUIWidget());
    String title = HelperDepot.getTitle(e.getGUIWidget());
    if (EventType.select == type) {
  ...
  public static void handleImageButton(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    assert e.getGUIWidget() instanceof NViewAllocNode;
    EventType type = e.getEventType();
    int resId = HelperDepot.getResId(e.getGUIWidget());
    if (EventType.click == type) {
  ...
  public static void handleTextView(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    assert e.getGUIWidget() instanceof NInflNode;
    // int resId = HelperDepot.getResId(e.getGUIWidget());
    String title = HelperDepot.getTitle(e.getGUIWidget());
    EventType type = e.getEventType();
...
//      testCase.append("solo.clickOnText(\"PASSWORD\");");
  ...
  public static void handleEditText(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    assert e.getGUIWidget() instanceof NInflNode;
    EventType type = e.getEventType();
  ...
  public static void handleMenu(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
  ...
  public static void handleMenuItem(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    assert e.getGUIWidget() instanceof NInflNode;
    EventType type = e.getEventType();
  ...
  public static void handleDialog(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
  ...
  public static void handleProgressBar(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
  ...
  public static void handleSpinner(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
  ...
  public static void handleCheckBox(WTGEdge e, RoboSynthesizer.TestCase testCase) throws Exception {
    EventType type = e.getEventType();
    if (EventType.select == type) {
      int resId = HelperDepot.getResId(e.getGUIWidget());
      if (-1 != resId) {
